...
public enum ErrorCode {
    ...
    PARENT_NOT_FOUND(HttpStatus.NOT_FOUND, "NOT_FOUND", "부모 계정을 찾을 수 없습니다."),
    ...
    PET_NOT_FOUND(HttpStatus.NOT_FOUND, "NOT_FOUND", "펫을 찾을 수 없습니다."),
    MISSION_NOT_FOUND(HttpStatus.NOT_FOUND, "NOT_FOUND", "미션을 찾을 수 없습니다."),
    MISSION_SET_NOT_FOUND(HttpStatus.NOT_FOUND, "NOT_FOUND", "학습 세트를 찾을 수 없습니다."),
    MISSION_SET_LOCKED(HttpStatus.FORBIDDEN, "MISSION_SET_LOCKED", "아직 잠긴 학습 세트입니다."),
    MISSION_SET_MISMATCH(HttpStatus.CONFLICT, "MISSION_SET_MISMATCH", "문제 세션의 학습 세트와 요청 세트가 일치하지 않습니다."),
    INVALID_STAR_LEVEL(HttpStatus.BAD_REQUEST, "INVALID_STAR_LEVEL", "starLevel은 1, 2, 3 중 하나여야 합니다."),
    INSUFFICIENT_ENERGY(HttpStatus.CONFLICT, "INSUFFICIENT_ENERGY", "학습 시작에 필요한 에너지가 부족합니다."),
    ...
    MISSION_SET_NOT_READY(HttpStatus.CONFLICT, "MISSION_SET_NOT_READY", "문제 세트를 준비하는 데 실패했습니다."),
    ...
    ATTEMPT_NOT_REVIVABLE(HttpStatus.CONFLICT, "ATTEMPT_NOT_REVIVABLE", "부활할 수 없는 문제 시도입니다."),
    ATTEMPT_NOT_FOUND(HttpStatus.NOT_FOUND, "NOT_FOUND", "문제 시도를 찾을 수 없습니다."),
    REPORT_NOT_FOUND(HttpStatus.NOT_FOUND, "NOT_FOUND", "풀이 리포트를 찾을 수 없습니다."),
    GEAR_NOT_ENOUGH(HttpStatus.CONFLICT, "GEAR_NOT_ENOUGH", "톱니바퀴가 부족합니다."),
    SHIELD_NOT_ENOUGH(HttpStatus.CONFLICT, "SHIELD_NOT_ENOUGH", "사용할 불꽃 방패가 없습니다."),
    STREAK_NOT_RECOVERABLE(HttpStatus.CONFLICT, "STREAK_NOT_RECOVERABLE", "지금은 불꽃 방패를 사용할 수 없습니다."),
    RECOVERY_EXPIRED(HttpStatus.CONFLICT, "RECOVERY_EXPIRED", "복구 가능한 시간이 지났습니다."),
